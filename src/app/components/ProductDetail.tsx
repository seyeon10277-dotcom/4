...
    price: 29.99, // Update price for cart logic to match the new sale price
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} className="relative">
            {/* 영문 텍스트 높이를 고려하여 lg:h-[600px]로 절대 고정 */}
          ...
          {/* Product Info */}
          {/* 텍스트 영역도 이미지와 동일하게 lg:h-[600px]로 강제 고정하여 레이아웃 시프트 차단 */}
          <motion.div initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} className="flex flex-col space-y-6 h-[500px] lg:h-[600px]">
            ...
            {/* mt-auto가 한국어 버전의 남는 여백을 밀어내어 높이 유지 */}
...
          <h2 className="text-3xl font-bold text-[#111111] mb-6">{language === 'ko' ? '제품설명' : 'Product Description'}</h2>
