...
const translations = {
  ko: {
    ...
    'hero.title1': '블랙핑크\n스페셜 에디션\n스킨케어 세트',
    'hero.title2': '비모트\n수분 선 세럼\nSPF 50',
    'hero.desc1': '블랙핑크 스페셜 에디션 스킨케어 세트를\n합리적인 가격에 만나고, 전 세계가 주목하는\n블랙핑크와 함께하는 가장 깨끗한 뷰티 루틴을 시작해보세요!',
    ...
    'footer.product2': 'BLACKPINK 스페셜 에디션',
  ...
  en: {
    ...
    'hero.title1': 'BLACKPINK Special Edition Skincare Set',
    'hero.title2': 'Bemot Moisturizing Sun Serum SPF 50',
    'hero.desc1': 'Experience the BLACKPINK Special Edition Skincare Set\nat an exceptional value, and start your purest beauty routine\nwith the globally acclaimed Blackpink!',
    ...
    'footer.product2': 'BLACKPINK Special Edition',
